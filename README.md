...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libquickfix-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libquickfix-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libquickfix
# for installing globally
pixi global install libquickfix
```
...
It is possible to list all of the versions of `libquickfix` available on your platform:
...
```
pixi search libquickfix --channel conda-forge
```
